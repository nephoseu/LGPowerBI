...
lab:
    ...
    module: '[01] Get Data in Power BI'
---
...
1. In the **Open** window, navigate to the **D:\PBI_Training\Labs\01-prepare-data-with-power-query-in-power-bi-desktop\Starter** folder.

1. Select the **Sales Analysis** file.

1. Save a copy of the file with **Save As** in to the **D:\PBI_Training\MySolution** folder.
...
1. In the **SQL Server Database** window, in the **Server** box, enter **lglobal.database.windows.net**, then select **OK**. AdventureWorksDW2020

1. Select "Database" in the left menu to use SQL credentials

    ![image](Image/Images/01_01.png)
    - Username: lglobal.database.windows.net
...
1. In the **Open** window, navigate to the **C:\PBI_Training\Resources** folder, and select the **ResellerSalesTargets.csv** file. Select **Open**.
...
1. Repeat the steps to create a query based on the **C:\PBI_Training\Resources\ColorFormats.csv** file.

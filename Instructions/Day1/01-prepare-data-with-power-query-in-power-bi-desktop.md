---
lab:
    title: '[Lab 01] Load Data in Power BI data model'
    module: ' Load Data in Power BI data model'
---
...
Liberty Global theme has been applied to the file as well. It is located in the Resources folder, in case you need to reapply it.
...
1. In the **SQL Server Database** window, in the **Server** box, enter **lglobal2.database.windows.net**, then select **OK**. AdventureWorksDW2020

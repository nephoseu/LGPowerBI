---
lab:
    title: '[Lab 05] Design a Report in Power BI Desktop'
    module: 'Design a Report in Power BI Desktop'
---
...
In this task, you'll set up the environment for the lab by opening the starter report, or from continuing from **LAB 04b**, most likely located in C:\PBI_Training\MySolution\Lab_04.
*Important: If you're continuing on from the lab 04b (and you completed that lab successfully), don't complete this task; instead, skip to the next task.*

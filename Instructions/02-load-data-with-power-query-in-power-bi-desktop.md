---
lab:
    title: '[02] Transform the data with PowerQuery'
    module: '[02] Transform the data with PowerQuery'
---

# Transform the data with PowerQuery
...
1. In the **Custom Column Formula** box, enter the following expression (after the equals symbol):
    - *You can copy the expression from the **C:\PBI_Training\Labs\02-load-data-with-power-query-in-power-bi-desktop\Assets\Snippets.txt** file.*

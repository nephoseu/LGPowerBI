---
lab:
    title: '[04] Design a Report in Power BI Desktop'
    module: '[04] Design a Report in Power BI Desktop'
---
...
In this task, you'll set up the environment for the lab by **opening the starter report**. You might notice some extra fields in the data, we will re-create them on day 2 of the training. 

1. From Power BI Desktop, navigate to **File** > **Open report** > **Browse Reports**.

1. Open the **Sales Analysis** file in the  **C:\PBI_Training\StarterFiles\Lab_04** folder.

1. Create a copy of the file by going to **File** > **Save As**, and save the copy in the **C:\PBI_Training\MySolution\Lab_04** folder.
...
1. In the **Open** window, navigate to the **C:\PBI_Training\Resources** folder.

1. Select the **LGLogo.png** file, and then select **Open**.

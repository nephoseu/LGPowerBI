---
lab:
    title: 'PowerBI Service - Dashboards, Alerts, Sharing, Security'
    module: '[07] PowerBI Service - Dashboards, Alerts, Sharing, Security'
---
...
1. Navigate to **C:\PBI_Training\Labs\09-create-power-bi-dashboard\Starter** folder.
...
1. In the **Add Image Tile** pane, in the **URL** box, enter the complete URL  **https://www.libertyglobal.com/wp-content/themes/Liberty/assets/img/liberty-logo-orange.svg**, and then **Apply**.
...
In this exercise, you'll update the dataset to point to a database, which includes sales order data for June 2020. You'll then open your Power BI Desktop file, change the datasource, and then upload the file to your workspace.

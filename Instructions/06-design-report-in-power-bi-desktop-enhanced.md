---
lab:
    title: 'Making reports interactive'
    module: '[06] Making reports interactive'
---
...
In this task, you'll set up the environment for the lab by opening the starter report, or from continuing from **LAB 04**, most likely located in C:\PBI_Training\MySolution\Lab_04.
*Important: If you're continuing on from the lab 04 (and you completed that lab successfully), don't complete this task; instead, skip to the next task.*

1. To open the starter Power BI Desktop file, select the **File > Open Report > Browse Reports**.

1. In the **Open** window, navigate to the **C:\PBI_Training\StarterFiles\Lab_06** folder, and open the **Sales Analysis** file.
...
1. To create a copy of the file, go to **File > Save As** and save to **C:\PBI_Training\MySolution\Lab_06** folder.

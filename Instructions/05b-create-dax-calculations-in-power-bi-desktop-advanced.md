...
lab:
    ...
    module: '[05b] Advanced DAX Calculations'
---
...
1. In the **Open** window, navigate to the **C:\PBI_Training\Labs\05-create-dax-calculations-in-power-bi-desktop-advanced\Starter**  folder, and open the **Sales Analysis** file.
...
1. Add a measure to the **Sales** table, based on the following expression:
	 ...
	 *For your convenience, all DAX definitions in this lab can be copied from the **C:\PBI_Training\Labs\05-create-dax-calculations-in-power-bi-desktop-advanced\Assets\Snippets.txt** file.*
